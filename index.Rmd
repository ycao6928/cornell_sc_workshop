...
You can find the workshop slides [here](slides_feb2020.pdf). 
...
## Running workshop locally {#local}
  ...
  1. In your RStudio console pane, please install all the necessary packages by running [this script](https://raw.githubusercontent.com/SydneyBioX/cornell_sc_workshop/master/install.R). This will take a while. 

  1. Download all the the workshop materials from [this zip file](https://github.com/SydneyBioX/cornell_sc_workshop/archive/master.zip) and unzip it on your Desktop. You should have a folder with the name `/desktop/cornell_sc_workshop-master` created.
  
  1. Download the data from [this zip file](https://storage.googleapis.com/scp_data/data.zip) and unzip this file under `/desktop/cornell_sc_workshop-master`, so that you should have a folder created as `/desktop/cornell_sc_workshop-master/data`. 
  
  1. Open up `/desktop/cornell_sc_workshop-master/cornell_sc_workshop.Rproj` and you should be able to run every `.Rmd` file in the workshop now. 
